...
# The selected input directory is scanned recursively. Unsupported files such as
# YAML and Markdown are skipped by the image generator.
MAX_DETECTIONS=20
