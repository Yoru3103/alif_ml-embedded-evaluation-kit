...
APPLICATION="${BUILD_DIR}/bin/mlek_object_detection.axf"
...
if [[ ! -f "${APPLICATION}" ]]; then
    ...
    printf 'Run scripts/build_face_detection_fvp320.sh first.\n' >&2
    exit 1
fi
...
printf 'Running Corstone-320 FVP face detection demo\n'
